...
.ez.reshape.msg<-function(type, number){
  ...
  # number : number of message
    msg<-c(ASK_chose_cols_corresponding_to_repeated_measures,
           ...
           INFO_should_specify_nb_factors_repeated_measure,
           ASK_did_not_specify_nb_factors_repeated_measure_exit,
           INFO_non_numeric_value,
           INFO_you_have_selected, TXT_cols,
           INFO_modalities_product_must_correspond_to_cols_selected,
