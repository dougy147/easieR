...
fiabilite <-
  function(X=NULL,Y=NULL, data=NULL, choice=NULL, ord=NULL,outlier="Complete data", keys=NULL, n.boot=NULL, sauvegarde=F, 
           imp=NULL, html=TRUE){
    # choice
    ...
    Results$Call<-paste0("fiabilite(X=c('", X,"'),Y=", ifelse(is.null(Y), "NULL", paste0("'",Y,"'")), ",data=", nom, ",choice='", choice,"',ord=", 
