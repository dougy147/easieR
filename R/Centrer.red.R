Centrer.red <-
  function(x, data=NULL, info=TRUE){options (warn=-1) 
    ...
    nom<-dlgList(c(nom,"autres donnees") , multiple = FALSE, title="Choice of dataframe")$res
    ...
    dlgList(c("centrer", "centrer reduire", "probabilite inferieure", "probabilite superieure"), preselect="centrer reduire", multiple = TRUE, title="What do you want to do ?")$res->choix
