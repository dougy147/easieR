...
desc_bootstrap_must_be_positive_integer <- "Le nombre de bootstrap doit etre un nombre entier positif"
...
desc_nb_factors_must_be_positive_integer_inferior_to_variables_nb <- "Le nombre de facteur doit etre un entier positif inferieur au nombre de variables"
...
txt_values <- "valeurs"
txt_considered_outliers <- "Valeurs considerees comme influentes"
txt_variables <- "Variables"
ask_ordinal_varibales <- "Variables ordinales ?"
