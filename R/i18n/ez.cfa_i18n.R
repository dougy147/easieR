...
ask_analysis_on_complete_dataset_or_without_outliers <- "Desirez-vous l'analyse sur les donnees completes ou sur les donnees pour lesquelles les valeurs influentes ont ete enlevees ?"
...
desc_bootstrap_must_be_a_positive_int <- "Le nombre de bootstrap doit etre un nombre entier positif"
...
txt_standardized_residuals <- "Residus standardises"
...
txt_values_considered_as_outliers <- "Valeurs considerees comme influentes"
...
ask_bootstraps_number <- "Veuillez preciser le nombre de bootstrap. Pour ne pas avoir de bootstrap, choisir 1"
