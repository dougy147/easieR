...
desc_author <- "author: 'Generate automatically by easyR'"
...
txt_hypergeom_total_sample_not_fixed_rows_cols <- "hypergeom - Total fixed strength for rows and columns"
...
txt_N_of_XY_NUM_corr <- "N of XY:NUM correlation"
txt_N_of_XZ_corr <- "N of XZ correlation"
txt_N_of_XZ_NUM_corr <- "N of XZ:NUM correlation"
...
txt_sample_size_NUM <- "Size of sample:NUM"
...
txt_step <- "etape"
txt_student_bootstrap_on_truncated_means <- "bootstrap studentise sur les moyens trunquees"
...
txt_user_exited_easieR <- "You left easyR"
txt_values <- "values"
txt_value <- "value"
...
txt_XY_NUM_correlation <- "Correlation between XY:NUM"
txt_XZ_correlation <- "Correlation between XZ"
txt_XZ_NUM_correlation <- "Correlation between XZ:NUM"
txt_y_axis_variables <- "Variable-s ordered"
txt_yes <- "yes"
txt_your_data <- "Your data"
txt_YZ_correlation <- "Correlation between YZ"
txt_YZ_NUM_correlation <- "Correlation between YZ:NUM"
