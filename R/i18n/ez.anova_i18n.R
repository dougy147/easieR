txt_complte_dataset <- "Donnees completes"
txt_complte_dataset <- "Complete dataset"
txt_identification_outliers <- "Identification of outliers"
txt_identification_outliers <- "Identification des valeurs influentes"
txt_dataset_with_outliers_removed <- "Donnees sans valeur influente"
txt_dataset_with_outliers_removed <- "Dataset with outliers removed"
txt_none <- "none"
txt_none <- "aucun"
txt_pairwise <- "pairwise"
txt_pairwise <- "Comparaison 2 a 2"
txt_anova <- "Anova"
...
ask_contrasts_must_be_ortho <- "Les contrastes doivent respecter l orthogonalite. Voulez-vous continuer ?"
...
ask_probability_correction <- "Quelle correction de la probabilite voulez-vous appliquer ? Pour ne pas appliquer de correction, choisir +none+"
...
txt_normality_test <- "Tests de normalite"
...
txt_references_of_used_packages <- "References des packages utilises pour cette analyse"
