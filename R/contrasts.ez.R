contrasts.ez <-
  function(longdata, inter=NULL, intra=NULL){
    ...
    if(type.cont=="a priori") {
      contrasts<-list()
      writeLines("Vous pouvez choisir les contrasts que vous souhaitez. Neanmoins les regles concernant l'application des contrasts doivent etre respectees.
                 Les contrasts peuvent etre specifies manuellement. Dans ce cas, veuillez choisir specifier les contrasts")
      cont.exemple<-list()
