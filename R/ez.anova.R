...
.ez.anova.msg<-function(type, number){
  ...
  if(grepl("French",Sys.setlocale()) | grepl("fr",Sys.setlocale())) {
    ...
    title<-c("Quel-s type-s de variables ?", "Mesures repetees","Identifiant participant","Variables with independent groups",
             "Variable dependante", "Covariable-s ?",
             "Modele parametrique", "Modele non parametrique","Facteurs bayesiens", "Robust statistics - can take time",
             ...
             "Voulez-vous sauvegarder ?", "a priori",  "Comparaison 2 a 2", "aucun","What kind of contrast do you want?",
             ...
             "Tests de normalite","Ancova application conditions","Test for the absence of difference between groups on ",
             ...
             "Analyse principale","Anova with Welch's correction for heterogeneous variances", "Comparaisons 2 a 2","contrastes",
             "Matrix of variable coefficients","Table des contrastes","Table of contrasts imitating commercial software","Facteurs bayesiens",
             "Analyse non parametrique","Test de Kruskal-Wallis","Anova de Friedman","Comparison 2 to 2 for Friedman's ANOVA",
             "Kruskal-Wallis test - Two by two comparison"  ,"Anova sur les medianes","Analyse principale","Anova based on truncated averages",
             "ANOVA sur M estimator", "Anova on the modified Huber localization estimator","Arret premature de l'analyse",
